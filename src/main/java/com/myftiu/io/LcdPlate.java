...
public class LcdPlate  implements Lcd {
    ...
    public LcdPlate(int busNo, int address) throws IOException, I2CFactory.UnsupportedBusNumberException {
        this.columns = 16;
        this.rows = 2;
